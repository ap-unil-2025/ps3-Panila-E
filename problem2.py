...
def temperature_converter():
    value=int(input("What is your temperature value?"))
    unit=input("Enter your temperature unit - C or F")
    if unit=="C":
        res=celsius_to_fahrenheit(value)
    elif unit=="F":
        res=fahrenheit_to_celsius(value)
    return (round(res,2))
    """
